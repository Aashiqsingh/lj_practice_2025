...
// q2
// var TotalEmployee = company.reduce((sum,comp)=> sum + comp.employees.length,0);
// console.log(TotalEmployee);

// q3
// var findEmpPosition = company.find((comp)=> comp.employees.find((emp)=> emp.name === "Emily Davis")).employees.find((emp)=> emp.name === "Emily Davis").position
// console.log(findEmpPosition);

// q5
// var findCompany = company.find((comp)=>{
...
// var findTechAvgSal = company.find((comp)=> comp.companyname === "Tech Solutions").employees.reduce((sum,emp)=> sum + emp.salary / 2 ,0);
// console.log(findTechAvgSal);
